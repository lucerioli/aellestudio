...
export default function ChiSiamo() {
  ...
  // Chiudi overlay se si clicca fuori (solo mobile)
  useEffect(() => {
    const handleClickOutside = (e) => {
      if (window.innerWidth < 768 && activeProfile && !e.target.closest('[data-profile]')) {
  ...
  return (
    <div className="space-y-24 pb-24">
      ...
      {/* I CONSULENTI - Overlay su mobile come servizi */}
      <section className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative w-full max-w-4xl mx-auto flex flex-col md:flex-row gap-12">
          ...
          <div 
            ...
            onClick={(e) => {
              e.stopPropagation()
              setActiveProfile(activeProfile === 'alessia' && window.innerWidth < 768 ? null : 'alessia')
            }}
          >
            ...
            {/* OVERLAY BIO MOBILE (come servizi) */}
            <div className={`md:hidden absolute inset-0 bg-slate-900/95 p-8 flex flex-col justify-center items-center text-center rounded-3xl transition-all duration-500 ease-out z-20 ${activeProfile === 'alessia' ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'}`}>
              <h3 className="text-2xl font-bold text-white mb-4" style={{ fontFamily: 'var(--font-serif)' }}>Dott.ssa Alessia Cerioli</h3>
              <p className="text-xs font-semibold text-slate-300 uppercase tracking-widest mb-6">Dottoressa Commercialista</p>
              <div className="space-y-3 text-slate-200 leading-relaxed text-sm">
              ...
              <Link href="/prenotazioni" className="mt-6 inline-flex items-center gap-2 text-white font-bold text-sm">
          ...
          <div 
            ...
            onClick={(e) => {
              e.stopPropagation()
              setActiveProfile(activeProfile === 'luca' && window.innerWidth < 768 ? null : 'luca')
            }}
          >
            <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-md transition-all duration-500">
              <Image 
            ...
            {/* OVERLAY BIO MOBILE (come servizi) */}
            <div className={`md:hidden absolute inset-0 bg-slate-900/95 p-8 flex flex-col justify-center items-center text-center rounded-3xl transition-all duration-500 ease-out z-20 ${activeProfile === 'luca' ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'}`}>
              <h3 className="text-2xl font-bold text-white mb-4" style={{ fontFamily: 'var(--font-serif)' }}>Rag. Luca Cerioli</h3>
              <p className="text-xs font-semibold text-slate-300 uppercase tracking-widest mb-6">Tributarista</p>
              <div className="space-y-3 text-slate-200 leading-relaxed text-sm">
          ...
          {/* === DESKTOP OVERLAY: Bio di Alessia (scorre da DESTRA) === */}
          ...
          {/* === DESKTOP OVERLAY: Bio di Luca (scorre da SINISTRA) === */}

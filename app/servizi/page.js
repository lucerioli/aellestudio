...
const SERVICES = [
  ...
  { id: 'consulenza-lavoro', title: 'Consulenza del lavoro', icon: <Users size={24} />, desc: 'Gestione buste paga, adempimenti previdenziali e contrattualistica. Assistenza su welfare aziendale, licenziamenti, assensioni agevolate e relazioni sindacali.' },
  { id: 'consulenza-societaria', title: 'Consulenza societaria', icon: <Building2 size={24} />, desc: 'Supporto nella costituzione, trasformazione, fusioni e scissioni. Assistenza nella redazione di statuti, patti parasociali e nella gestione degli organi societari.' },
  { id: 'consulenza-fiscale', title: 'Consulenza fiscale', icon: <ShieldCheck size={24} />, desc: 'Pianificazione tributaria strategica e ottimizzazione del carico fiscale. Assistenza in sede di contenzioso, interpelli e gestione dei rapporti con l\'Agenzia delle Entrate.' },
      ...
      <section className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {SERVICES.map((service) => (
            ...
            >
              {/* LAYER BASE: Titolo e Icona (visibile a riposo) */}
              ...
              {/* LAYER DETTAGLIO: Overlay che appare SOLO su hover desktop */}
              <div className="absolute inset-0 bg-slate-900 p-8 flex flex-col justify-center items-center text-center opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 ease-out md:pointer-events-none">
